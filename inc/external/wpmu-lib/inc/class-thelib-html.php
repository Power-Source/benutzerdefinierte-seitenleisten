...
class TheLib_Html extends TheLib  {
	...
	public function _enqueue_pointer() {
		...
		wp_enqueue_script( 'pssidebars-pointer-polyfill', plugins_url( 'pointer-polyfill.js', __FILE__ ), array( 'jquery' ), '1.0.0', true );
		wp_enqueue_style( 'pssidebars-pointer-polyfill', plugins_url( 'pointer-polyfill.css', __FILE__ ), array(), '1.0.0' );
	}
